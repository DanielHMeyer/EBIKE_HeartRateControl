function rider = DefineRiderSimple(m, h, age, TL, sex, HR_rest, n_max, n_des, v_ref)
%% Motor
...
rider.age = age;
rider.sex = sex;
[rider.HR_max, rider.P_max, rider.HR_IAT, rider.P_IAT, rider.grade_IAT, rider.grade_MAX, rider.t_IAT, rider.t_MAX] = HR_P_Rider_Simple(age,sex,h,m);
